package cn.s07150818edu.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    public  void anr(View v){
        for (int i=0;i<10000;i++){
            BitmapFactory.decodeResource(getResources(),R.drawable.android1);
        }
    }
    public  void threadclass (View v){
        class ThreadSample extends Thread{
            Random rm;
            public ThreadSample(String tanme){
                super(tanme);
                rm=new Random();
    ...
    public  void runableclass (View v){
        class RunbleExample implements Runnable{
            Random rm;
            String name;
            public RunbleExample(String tanme){
               this.name=tanme;
                rm=new Random();
